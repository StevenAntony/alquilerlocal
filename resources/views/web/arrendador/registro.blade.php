                ...
                <div class="col-md-12">
                    <div class="aa-contact-area" style="background-color: #f3f7f8;">
                        <div class="aa-contact-bottom">
                            <div class="aa-title pt-5 text-center pb-5">
                                <h2>Registro</h2>
                            </div>
                            <div class="aa-contact-form" style="display: flex;flex-wrap: wrap;justify-content: center;">
                                <form id="formRegistro" class="form_registro d-flex flex-wrap col-md-6 col-12"
                                    action="{{ route('web.registrar.arrendador') }}" method="post">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="input-container-main">
                                            <label for="input-email" class="label-form-main" style="">Tipo</label>
                                            <select class="select-form-main validar-formulario form-control"
                                                text-validate="Ingrese tipo documento" name="itmTipoDocumento"
                                                id="itmTipoDocumento">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-container-main">
                                            <label for="itmDocumento" class="label-form-main"
                                                style="">Documento</label>
                                            <input id="itmDocumento" type="text" name="itmDocumento" autocomplete="off"
                                                text-validate="Ingrese Documento"
                                                class="input-form-main validar-formulario form-control" value=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-container-main">
                                            ...
                                            <input id="itmNombre" type="text" name="itmNombre" autocomplete="off"
                                                text-validate="Ingrese Nombre" class="input-form-main validar-formulario
                                                form-control"
                                                value="" placeholder="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-container-main">
                                            <label for="itmApellido" class="label-form-main"
                                                style="">Apellidos</label>
                                            <input id="itmApellido" type="text" name="itmApellido" autocomplete="off"
                                                text-validate="Ingrese Apellido" class="input-form-main validar-formulario form-control"
                                                value="" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input-container-main">
                                            <label for="itmRazonSocial" class="label-form-main" style="">Razón
                                                Social</label>
                                            <input id="itmRazonSocial" disabled="true" type="text" name="itmRazonSocial"
                                                text-validate="Ingrese Razón Social" autocomplete="off"
                                                class="input-form-main validar-formulario form-control" value="" placeholder="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-container-main">
                                            ...
                                            <input id="itmCorreo" type="text" name="itmCorreo" autocomplete="off"
                                                text-validate="Ingrese Correo" class="validar-formulario input-form-main form-control"
                                                value="" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-container-main">
                                            <label for="itmTelefono" class="label-form-main"
                                                style="">Teléfono</label>
                                            <input id="itmTelefono" type="text" name="itmTelefono" autocomplete="off"
                                                text-validate="Ingrese Teléfono"
                                    ...
                                    <div class="col-md-12 mt-2 mb-5">
                                        <div class="d-flex" style="display:flex;justify-content:center;">
                                            <div class="col-md-6">
                                                <button type="button" id="btnRegistrar" class="btn btn-primary btn-block"
                                                    name="button">Registrar</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
