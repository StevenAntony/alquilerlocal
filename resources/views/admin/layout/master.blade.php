...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('app.inicio')}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Mios</h6>
                        <a class="collapse-item" href="{{route('app.realizarpublicacion')}}">Realizar</a>
                        <a class="collapse-item" href="{{route('app.visitasolicitud')}}">Solicitudes</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Alquilar propiedad:</h6>
                        <a class="collapse-item" href="{{route('app.visitarespuesta')}}">Respuesta</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><i class="fa fa-user"></i></span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <form action="{{route('app.cerrarsesion')}}" method="post">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <button type="submit" style="background: transparent;border: none">Cerrar Sesión </button>
                                    </a>
                                </form>
                            </div>
                        </li>
